...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="card mb-4">
                <div class="card-header">
                    <i class="fas fa-users"></i> Alumnos Registrados
                </div>
                <div class="card-body">
    ...
    <div class="modal fade modal-xl" id="seeTotalModal" aria-labelledby="seeTotalModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="seeTotalModalLabel"></h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body" id="seeTotalModalBody">
    ...
    <div class="modal fade" id="addHoursModal" aria-labelledby="addHoursModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
