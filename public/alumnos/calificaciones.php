                                ...
                                <tr>
                                    <th scope="row">
                                        <div class="row g-2">
                                            ...
                                            <div class="col-md">
                                                <select class="form-select subjectChildName" name="subjectChild"
                                                    id="subjectChild">
                ...
                <div class="card-header">
                    <ul class="nav nav-tabs card-header-tabs">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="studentsListGrades" data-bs-toggle="tab"
                                data-bs-target="#studentGradesTable" type="button" role="tab"
                                aria-controls="studentGradesTable" aria-selected="true">Calificaciones</button>
                        </li>
                        <li class="nav-item">
                            <button class="nav-link" id="studentDetails" data-bs-toggle="tab"
                                data-bs-target="#studentGroupDetails" type="button" role="tab"
                                aria-controls="studentGroupDetails" aria-selected="true">Grupo</button>
                        </li>
                    </ul>
                </div>
                <div class="card-body">
                    <div class="tab-content" id="myTabContent">
                        <!-- Calificaciones Tab -->
                        <div class="tab-pane fade show active" id="studentGradesTable" role="tabpanel"
                            aria-labelledby="studentGradesTable" tabindex="0">
                        ...
                        <!-- Grupo Tab -->
                        <div class="tab-pane fade" id="studentGroupDetails" role="tabpanel"
                            aria-labelledby="studentGroupDetails" tabindex="0">
                            <div id="alertDisplay">
                                ...
                                <form id="studentGroupDetailsForm">
                                    <div class="row g-2">
                                        <div class="col-md">
                                            ...
                                            <div>
                                                <p class="py-1">
                                                    <label id="studentIdGroup-error" class="error text-bg-danger"
                                                        for="studentIdGroup"
