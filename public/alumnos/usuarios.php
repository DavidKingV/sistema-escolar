...
<head>
    ...
    <title>Usuarios de alumnos</title>
</head>
        ...
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <a href="altas.php" class="btn btn-secondary">
                    <i class="bi bi-plus"></i> Agregar Alumno
                </a>
            </div>

            <div class="card border-primary shadow mb-4">
                <div class="card-header bg-primary text-white">
                    <i class="fas fa-user-graduate"></i> Información del Alumno
                </div>
                <div class="card-body">
...
<!-- Modal -->
<div class="modal fade modal-lg" id="StutentUserModal" tabindex="-1" aria-labelledby="StutentUserModal"
    aria-hidden="true">
            ...
            <div class="modal-body">
                <form id="addStudentsUsers">
                    <div class="row g-2 py-3">
                        <div class="col-md hidden">
                            <div class="form-floating">
                                <input type="text" class="form-control hidden" id="studentUserId" name="studentUserId"
                                    readonly>
                    ...
                    <div class="row g-2 py-1">
                        <div class="col-md">
                            <div class="form-floating">
                                <input type="text" class="form-control" id="studentUserAdd" name="studentUserAdd"
                                    value="">
                                <label for="studentUserAdd">Usuario</label>
                            </div>
                            <label id="studentUserAdd-error" class="error text-bg-danger" for="studentUserAdd"
                                style="font-size: 12px; border-radius: 10px; padding: 0px 5px;"></label>
                            <div>
                                <p class="">
                                    <label class="error text-bg-danger userError"
                                        style="font-size: 12px; border-radius: 10px; padding: 0px 5px; display:none;"></label>
                                    <label class="error text-bg-success userSuccess"
                                        style="font-size: 12px; border-radius: 10px; padding: 0px 5px; display:none;"></label>
                                </p>
                            </div>
                        </div>
                        <div class="col-md">
                            <div class="form-floating input-group">
                                <input type="password" class="form-control" id="studentUserPass" name="studentUserPass"
                                    value="">
                            ...
                            <div>
                                <p class="">
                                    <label id="studentUserPass-error" class="error text-bg-danger" for="studentUserPass"
                                        style="font-size: 12px; border-radius: 10px; padding: 0px 5px; display:none;"></label>
                                </p>
                            </div>
                        </div>
...
<!-- Modal -->
<div class="modal fade modal-lg" id="StutentUserEditModal" tabindex="-1" aria-labelledby="StutentUserEditModal"
    aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form id="editStudentsUsers">
                    <div class="row g-2 py-3">
                        <div class="col-md">
                            <div class="form-floating">
                                <input type="text" class="form-control" id="studentUserIdEdit" name="studentUserIdEdit"
                                    readonly>
                        ...
                        <div class="col-md">
                            <div class="form-floating">
                                <input type="text" class="form-control" id="studentUserNameEdit"
                                    name="studentUserNameEdit" readonly>
                    ...
                    <div class="row g-2 py-3">
                        <div class="col-md">
                            <div class="form-floating input-group">
                                <input type="text" class="form-control" id="studentUserAddEdit"
                                    name="studentUserAddEdit" value="" readonly>
                                <label for="studentUserAddEdit">Usuario</label>
                                <button class="btn btn-outline-secondary" type="button" id="editUserNameStudent">
                                    <i class="bi bi-pencil-fill"></i>
                                </button>
                            </div>
                            <label id="studentUserAddEdit-error" class="error text-bg-danger" for="studentUserAddEdit"
                                style="font-size: 12px; border-radius: 10px; padding: 0px 5px;"></label>
                            <label class="error text-bg-danger userError"
                                style="font-size: 12px; border-radius: 10px; padding: 0px 5px;"></label>
                            <label class="error text-bg-success userSuccess"
                        ...
                        <div class="col-md">
                            <div class="form-floating input-group">
                                <input type="password" class="form-control" id="studentUserPassEdit"
                                    name="studentUserPassEdit" value="">
                            ...
                            <label id="studentUserPassEdit-error" class="error text-bg-danger" for="studentUserPassEdit"
                                style="font-size: 12px; border-radius: 10px; padding: 0px 5px;"></label>
                        </div>
                    </div>
            </div>
...
<!-- Modal Microsoft-->
<div class="modal fade modal-lg" id="toMicrosoftModal" tabindex="-1" aria-labelledby="toMicrosoftModal"
    aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form id="toMicrosoftStudentUser">
                    <div class="row g-2 py-3">
                        <div class="col-md">
                            <div class="form-floating">
                                <input type="text" class="form-control" id="studentUserIdMicrosoft"
                                    name="studentUserIdMicrosoft" readonly>
                                <label for="studentUserIdMicrosoft">ID</label>
                            </div>
                        </div>
                        <div class="col-md">
                            <div class="form-floating input-group">
                                <input type="text" class="form-control" id="studentUserNameMicrosoft"
                                    name="studentUserNameMicrosoft">
                                <label for="studentUserNameMicrosoft">Nombre del alumno</label>
                                <button class="btn btn-outline-success" type="button" id="findMicrosoftUser">
