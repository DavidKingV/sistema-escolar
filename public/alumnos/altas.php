    ...
    <div id="content">
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2 class="mb-0">Agregar Alumno</h2>
            ...
            <div class="card border-primary shadow">
                <div class="card-header bg-primary text-white">
                    <i class="bi bi-person-badge-fill"></i> Información del alumno
                </div>
                <div class="card-body">
                    <form id="addStudents">
                        <div class="row">
                            ...
                            <?php if (isset($_SESSION["adnanhussainturki/microsoft"]["accessToken"])) { ?>
                                <div class="col-md-12 mb-3">
                                    <label for="microsoftUser" class="form-label">
                                        <i class="fas fa-id-card"></i> Buscar Usuario Microsoft <span
                                ...
                                <div class="col-md-12 mb-3" id="microsoftDiv" style="display: none;">
                                    <div class="alert alert-success" role="alert">
                                        ...
                                        <input type="text" readonly class="form-control-plaintext" id="microsoftId"
                                            name="microsoftId">
                                        <input type="text" readonly class="form-control-plaintext" id="microsoftEmail"
                                            name="microsoftEmail">
                                    </div>
                                </div>
                            <?php } ?>
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="controlNumber" class="form-label">
                                    No. control interno <span class="text-danger">*</span>
                                </label>
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="controlSepNumber" class="form-label">
                                    No. control SEP <span class="text-danger">*</span>
                                </label>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="phone-group d-flex">
                                    ...
                                    <input type="tel" class="form-control" id="studentPhone" name="studentPhone"
                                        placeholder="Número telefónico" required style="flex: 1;">
                                </div>
                            </div>
