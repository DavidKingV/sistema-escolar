    ...
    <div id="content">
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2 class="mb-0">Agregar Materia</h2>
            ...
            <div class="card border-primary shadow">
                <div class="card-header bg-primary text-white">
                    <i class="bi bi-book-half"></i> Información de la materia
                </div>
                <div class="card-body">
                    <form id="addSubjects">
                        <div class="row g-2">
                            <div class="col-md py-3">
                                <label for="subjectKey" class="form-label">Clave de la materia <span
                                        class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="subjectKey" name="subjectKey">
                            </div>
                            <div class="col-md py-3">
                                <label for="subjectName" class="form-label">Nombre de la materia <span
                                        class="text-danger">*</span></label>
                    ...
                    <form id="addSubjects">
                        <div class="row g-2">
                            <div class="col-md py-3">
                                ...
                                <label id="subjectNameTeacher-error" class="error text-bg-danger"
                                    for="subjectNameTeacher"
                                    style="font-size: 12px; border-radius: 10px; padding: 0px 5px;"></label>
                                <input type="text" class="form-control" id="subjectNameTeacher"
                                    name="subjectNameTeacher">
                            </div>
                        </div>
                        <div class="row g-2">
                            <div class="col-md py-3">
                                <label for="teacherNameSubject" class="form-label">Nombre del profesor</label>
                                <label id="teacherNameSubject-error" class="error text-bg-danger"
                                    for="teacherNameSubject"
                                    style="font-size: 12px; border-radius: 10px; padding: 0px 5px;"></label>
                                <input type="text" class="form-control" id="teacherNameSubject"
                                    name="teacherNameSubject">
                            </div>
                        </div>
                        <div class="row g-2">
                            <div class="col-md py-3">
