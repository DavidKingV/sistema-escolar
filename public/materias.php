...
<!-- Modal EDIT -->
<div class="modal fade modal-lg" id="SubjectsEditModal" data-bs-backdrop="static" tabindex="-1"
  aria-labelledby="SubjectsEditModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="loader" id="subjectEditLoader">
        ...
        <form id="updateSubject">
          <div class="row g-2">
            ...
            <div class="col-md">
              ...
              <label id="subjectNameEdit-error" class="error text-bg-danger" for="subjectNameEdit"
          ...
          <div class="row g-2 py-1">
            <div class="col-md">
              <div class="form-floating">
                <input type="text" class="form-control" id="descriptionSubjectEdit" name="descriptionSubjectEdit"
                  value="">
                <label for="descriptionSubjectEdit">Descripción</label>
              </div>
              <label id="descriptionSubjectEdit-error" class="error text-bg-danger" for="descriptionSubjectEdit"
                style="font-size: 12px; border-radius: 10px; padding: 0px 5px;"></label>
            </div>
          </div>
      </div>
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary" id="saveSubjectChanges">Guardar Cambios</button>
        </form>
      </div>
    </div>
  </div>
...
<!-- Modal ADD CHILD -->
<div class="modal fade modal-lg" id="SubjectsChildAddModal" data-bs-backdrop="static" tabindex="-1"
  aria-labelledby="SubjectsChildAddModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <form id="addSubjectChild">
          ...
          <div class="row g-2 py-4">
            ...
            <div class="col-md">
              ...
              <div>
                <p class="py-1">
                  <label id="subjectChildName-error" class="error text-bg-danger" for="subjectChildName"
            ...
            <div class="col-md">
              <div class="form-floating">
                <input type="text" class="form-control" id="descriptionChildSubject" name="descriptionChildSubject"
                  value="">
                <label for="descriptionChildSubject">Descripción</label>
              </div>
              <div>
                <p class="py-1">
                  <label id="descriptionChildSubject-error" class="error text-bg-danger" for="descriptionChildSubject"
                    style="font-size: 12px; border-radius: 10px; padding: 0px 5px; display:none;"></label>
                </p>
              </div>
            </div>
...
<!-- Modal CHILD INFO-->
<div class="modal fade modal-lg" id="childSubjectsModal" data-bs-backdrop="static" tabindex="-1"
  aria-labelledby="childSubjectsModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="loader" id="subjectChildEditLoader">
        <div class="spinner-border text-primary" role="status"></div>
        <span class="text-muted">Cargando...</span>
      </div>
      <div class="modal-header">
        ...
        <form id="subjectChildInfo">
          ...
          <div class="row g-2 py-4">
            <div class="col-md">
              ...
              <div>
                <p class="py-1">
                  <label id="subjectChildNameInfo-error" class="error text-bg-danger" for="subjectChildNameInfo"
                    style="font-size: 12px; border-radius: 10px; padding: 0px 5px; display:none;"></label>
                </p>
              </div>
            </div>
            <div class="col-md">
              <div class="form-floating">
                <input type="text" class="form-control" id="descriptionChildSubjectInfo"
                  name="descriptionChildSubjectInfo" value="">
                <label for="descriptionChildSubjectInfo">Descripción</label>
              </div>
              <div>
                <p class="py-1">
                  <label id="descriptionChildSubjectInfo-error" class="error text-bg-danger"
                    for="descriptionChildSubjectInfo"
                    style="font-size: 12px; border-radius: 10px; padding: 0px 5px; display:none;"></label>
                </p>
              </div>
            </div>
          ...
          <div class="modal-footer">
            ...
            <button type="button" id="deleteSubjectChildById" class="btn btn-danger">Eliminar</button>
          </div>
        </form>
      </div>
    </div>
