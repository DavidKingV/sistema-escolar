...
$("#teachersTable").on("click", ".editTeacher", function () {
  // Abre loader
  $("#teacherEditLoader").css("display", "flex");
...
const AddTeacherUser = async (teacherUserData) => {
  try {
    const response = await $.ajax({
      url: `${BASE_URL}/teacher/addTeacherUser`,
      type: "POST",
...
const VerifyTeacherUser = async (teacherUser) => {
  try {
    const response = await $.ajax({
      url: `${BASE_URL}/teacher/verifyTeacherByUser`,
      type: "GET",
...
const DesactivateTeacherUser = async (teacherUserId) => {
  try {
    const response = await $.ajax({
      url: `${BASE_URL}/teacher/desactivateTeacherUser`,
      type: "POST",
...
const ReactivateTeacherUser = async (teacherUserId) => {
  try {
    const response = await $.ajax({
      url: `${BASE_URL}/teacher/reactivateTeacherUser`,
      type: "POST",
      data: { teacherUserId: teacherUserId },
    });
    if (response.success) {
...
const UpdateTeacherUserData = async (teacherUserUpdateData) => {
  try {
    const response = await $.ajax({
      url: `${BASE_URL}/teacher/updateTeacherUserData`,
      type: "POST",
      data: teacherUserUpdateData,
    });
    if (response.success) {
      Swal.fire({
        icon: "success",
...
const GetTeacherData = async (teacherId) => {
  try {
    const response = await $.ajax({
      url: `${BASE_URL}/teacher/getTeacherById`,
      type: "GET",
...
const DeleteTeacher = async (teacherId, password) => {
  try {
    const response = await $.ajax({
      url: `${BASE_URL}/teacher/deleteTeacherById`,
      type: "POST",
...
const UpdateTeacherData = async (teacherUpdateData) => {
  try {
    const response = await $.ajax({
