...
$(
  "#controlNumber, #studentCurp, #keyGroupEdit, #nameGroupEdit, #keyGroup, #nameGroup, #descriptionSubjectEdit, #subjectDes, #subjectKey, #subjectKeyEdit",
...
$(
  "#studentNation, #studentEmail, #descriptionGroup, #descriptionGroupEdit, #teacherEmail, #teacherEmailEdit",
).on("input", function (event) {
  event.preventDefault();
  let cursorPosition = $(this).prop("selectionStart");
...
$("#subjectChildName, #subjectNameEdit, #subjectName").on(
  "input",
  function (event) {
    event.preventDefault();
    let cursorPosition = $(this).prop("selectionStart");
...
function initUpdateGroupValidation(onValidSubmit) {
  ...
  $form.validate({
    ...
    // El puente: valida y delega al callback
    submitHandler: function (form) {
      onValidSubmit($(form).serialize());
    },
  });
}
...
///////////////////////////////////////////////////////////////////////////////
export { initUpdateGroupValidation };
