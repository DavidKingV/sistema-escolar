...
$("#studentGradesTable").on("click", ".mekeOver", function () {
  ...
  $.post(
    "/modals/viewMakeOver.Modal.php",
    { studentId: studentIdGroup, makeOverId: makeOverId },
    function (data) {
...
$("#studentGradesTable").on("click", ".makeOverChild", function () {
  ...
  $.post(
    "/modals/viewMakeOver.Modal.php",
    { studentId: studentIdGroup, makeOverChildId: makeOverChildId },
    function (data) {
      $("#makeOverViewModalBody").html(data);
    },
  );
