      ...
      },
      {
        ...
        render: function (data, type, row) {
          return (
            ...
            '" data-student="' +
            row.studentId +
            '" class="btn btn-primary btn-circle GradeStudent"><i class="bi bi-journal-check"></i></button>'
          );
        },
        className: "text-center",
      },
      {
        ...
        render: function (data, type, row) {
          return (
            '<button data-id="' +
            row.studentId +
            '" class="btn btn-primary btn-circle editStudent" data-bs-toggle="modal" data-bs-target="#StutentEditModal"><i class="bi bi-pencil-square"></i></button><button id="deleteStudent" data-id="' +
            row.studentId +
