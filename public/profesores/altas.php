        ...
        <div class="container-fluid">
            ...
            <div class="card border-primary shadow">
                <div class="card-header bg-primary text-white">
                    <i class="bi bi-person-workspace"></i> Información del profesor
                </div>
                <div class="card-body">
                    <form id="addTeachers">
                        <div class="row g-2">
                            <div class="col-md py-3">
                                <label for="teacherName" class="form-label">Nombre completo <span
                                        class="text-danger">*</span></label>
                                <label id="teacherName-error" class="error text-bg-danger" for="teacherName"
                        ...
                        <div class="row g-2">
                            <div class="col-md py-3">
                                <label for="teacherGender" class="form-label">Género <span
                                        class="text-danger">*</span></label>
                                <label id="teacherGender-error" class="error text-bg-danger" for="teacherGender"
                                    style="font-size: 12px; border-radius: 10px; padding: 0px 5px;"></label>
                            ...
                            <div class="col-md py-3">
                                <label for="teacherBirthday" class="form-label">Fecha de nacimiento <span
                                        class="text-danger">*</span></label>
                                <label id="teacherBirthday-error" class="error text-bg-danger" for="teacherBirthday"
                                    style="font-size: 12px; border-radius: 10px; padding: 0px 5px;"></label>
                                <input type="date" class="form-control" id="teacherBirthday" name="teacherBirthday">
                            </div>
                            <div class="col-md py-3">
                                <label for="teacherState" class="form-label">Estado civil <span
                                        class="text-danger">*</span></label>
                                <label id="teacherState-error" class="error text-bg-danger" for="teacherState"
                                    style="font-size: 12px; border-radius: 10px; padding: 0px 5px;"></label>
                        ...
                        <div class="row g-2">
                            <div class="col-md py-3">
                                <label for="teacherPhone" class="form-label">Número telefónico <span
                                        class="text-danger">*</span></label>
                                <label id="teacherPhone-error" class="error text-bg-danger" for="teacherPhone"
                                    style="font-size: 12px; border-radius: 10px; padding: 0px 5px;"></label>
                                <input type="text" class="form-control" id="teacherPhone" name="teacherPhone">
                            </div>
                            <div class="col-md py-3">
                                <label for="teacherEmail" class="form-label">Correo electrónico <span
                                        class="text-danger">*</span></label>
                                <label id="teacherEmail-error" class="error text-bg-danger" for="teacherEmail"
                                    style="font-size: 12px; border-radius: 10px; padding: 0px 5px;"></label>
