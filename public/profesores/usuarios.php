    ...
    <div id="content">
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <a href="altas.php" class="btn btn-primary">
                    <i class="bi bi-plus"></i> Agregar Profesor
                </a>
            </div>
            <div class="card border-primary shadow">
                <div class="card-header bg-primary text-white">
                    <i class="fas fa-user"></i> Profesores Usuarios Registrados
                </div>
                <div class="card-body">
...
<!-- Modal -->
<div class="modal fade modal-lg" id="teacherUserModal" tabindex="-1" aria-labelledby="teacherUserModal"
    aria-hidden="true">
            ...
            <div class="modal-body">
                <form id="addTeachersUsers">
                    <div class="row g-2 py-3">
                        <div class="col-md">
                            <div class="form-floating">
                                <input type="text" class="form-control" id="teacherUserId" name="teacherUserId"
                                    readonly>
                    ...
                    <div class="row g-2 py-3">
                        <div class="col-md">
                            <div class="form-floating">
                                <input type="text" class="form-control" id="teacherUserAdd" name="teacherUserAdd"
                                    value="">
                                <label for="teacherUserAdd">Usuario</label>
                            </div>
                            <label id="teacherUserAdd-error" class="error text-bg-danger" for="teacherUserAdd"
                        ...
                        <div class="col-md">
                            <div class="form-floating input-group">
                                <input type="password" class="form-control" id="teacherUserPass" name="teacherUserPass"
                                    value="">
                            ...
                            <label id="teacherUserPass-error" class="error text-bg-danger" for="teacherUserPass"
                                style="font-size: 12px; border-radius: 10px; padding: 0px 5px;"></label>
                        </div>
                    </div>
            </div>
...
<!-- Modal -->
<div class="modal fade modal-lg" id="TeacherUserEditModal" tabindex="-1" aria-labelledby="TeacherUserEditModal"
    aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form id="editTeachersUsers">
                    <div class="row g-2 py-3">
                        <div class="col-md">
                            <div class="form-floating">
                                <input type="text" class="form-control" id="teacherUserIdEdit" name="teacherUserIdEdit"
                                    readonly>
                        ...
                        <div class="col-md">
                            <div class="form-floating">
                                <input type="text" class="form-control" id="teacherUserNameEdit"
                                    name="teacherUserNameEdit" readonly>
                    ...
                    <div class="row g-2 py-3">
                        <div class="col-md">
                            <div class="form-floating input-group">
                                <input type="text" class="form-control" id="teacherUserAddEdit"
                                    name="teacherUserAddEdit" value="" readonly>
                                <label for="teacherUserAddEdit">Usuario</label>
                                <button class="btn btn-outline-secondary" type="button" id="editUserNameteacher">
                                    <i class="bi bi-pencil-fill"></i>
                                </button>
                            </div>
                            <label id="teacherUserAddEdit-error" class="error text-bg-danger" for="teacherUserAddEdit"
                                style="font-size: 12px; border-radius: 10px; padding: 0px 5px;"></label>
                            <label class="error text-bg-danger userError"
                                style="font-size: 12px; border-radius: 10px; padding: 0px 5px;"></label>
                            <label class="error text-bg-success userSuccess"
                        ...
                        <div class="col-md">
                            <div class="form-floating input-group">
                                <input type="password" class="form-control" id="teacherUserPassEdit"
                                    name="teacherUserPassEdit" value="">
