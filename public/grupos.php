        ...
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <a href="grupos/altas.php" class="btn btn-primary">
                    <i class="bi bi-plus"></i> Agregar Grupo
                </a>
            </div>
            <div class="card mb-4">
                <div class="card-header">
                    <i class="bi bi-person-badge-fill"></i> Grupos Registrados
                </div>
                <div class="card-body">
                        ...
                        <table class="table" id="groupsTable">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">Miembro(s)</th>
...
<!-- Modal EDIT -->
<div class="modal fade modal-lg" id="GroupsEditModal" data-bs-backdrop="static" tabindex="-1"
    aria-labelledby="GroupsEditModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="loader" id="groupEditLoader">
