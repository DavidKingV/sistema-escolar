    ...
    <div id="content">
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2 class="mb-0">Agregar Carrera</h2>
                <a href="../carreras.php" class="btn btn-secondary">
            ...
            <div class="card border-primary shadow">
                <div class="card-header bg-primary text-white">
                    <i class="bi bi-mortarboard-fill"></i> Información de la carrera
                </div>
                <div class="card-body">
                    <form id="addCarreers">
                        <div class="row g-2">
                            <div class="col-md py-3">
                                <label for="careerName" class="form-label">Nombre de la carrera/especialidad <span
                            ...
                            <div class="col-md py-3">
                                <label for="careerArea" class="form-label">Área de la carrera/especialidad <span
                                        class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="careerArea" name="careerArea">
                            </div>
                            <div class="col-md py-3">
                                <label for="careerSubarea" class="form-label">Subárea de la carrera/especialidad <span
                                        class="text-danger">*</span></label>
                        ...
                        <div class="row g-2">
                            <div class="col-md py-3">
                                <label for="careerDes" class="form-label">Comentarios <span
                                        class="text-danger">*</span></label>
                                <textarea class="form-control" id="careerDes" name="careerDes"></textarea>
                            </div>
                        </div>
                        <div class="row g-2">
                            <div class="col-md py-3">
