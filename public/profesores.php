        ...
        <div class="container-fluid">
            ...
            <div class="card mb-4">
                <div class="card-header">
                    <i class="bi bi-person-workspace"></i> Profesores Registrados
                </div>
                <div class="card-body">
...
<!-- Modal edit -->
<div class="modal fade modal-lg" id="TeacherEditModal" data-bs-backdrop="static" tabindex="-1"
    aria-labelledby="TeacherEditModal" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="loader" id="teacherEditLoader">
                <div class="spinner-border text-primary" role="status"></div>
                <span class="text-muted">Cargando...</span>
            </div>
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="TeacherEditModalLabel">Editar Profesor</h1>
                ...
                <form id="editTeacherForm">
                    <div class="row g-2 py-4">
                        <div class="col-md">
                            <div class="form-floating">
                                <input type="text" class="form-control" id="idTeacherEdit" name="idTeacherEdit"
                                    readonly>
                        ...
                        <div class="col-md">
                            <div class="form-floating">
                                <input type="text" class="form-control" id="teacherNameEdit" name="teacherNameEdit"
                                    value="">
                    ...
                    <div class="row g-2 py-1">
                        <div class="col-md">
                            ...
                            <label id="teacherGenderEdit-error" class="error text-bg-danger" for="teacherGenderEdit"
                                style="font-size: 12px; border-radius: 10px; padding: 0px 5px;"></label>
                        </div>
                        <div class="col-md">
                            <div class="form-floating">
                                <input type="date" class="form-control" id="teacherBirthdayEdit"
                                    name="teacherBirthdayEdit" value="">
                                <label for="teacherBirthdayEdit">Fecha de nacimiento</label>
                            </div>
                            <label id="teacherBirthdayEdit-error" class="error text-bg-danger" for="teacherBirthdayEdit"
                                style="font-size: 12px; border-radius: 10px; padding: 0px 5px;"></label>
                        </div>
                        <div class="col-md">
                            <div class="form-floating">
                            ...
                            <label id="teacherStateEdit-error" class="error text-bg-danger" for="teacherStateEdit"
                                style="font-size: 12px; border-radius: 10px; padding: 0px 5px;"></label>
                        </div>
                    </div>
                    <div class="row g-2 py-1">
                        <div class="col-md">
                            <div class="form-floating">
                                <input type="text" class="form-control" id="teacherPhoneEdit" name="teacherPhoneEdit"
                                    value="">
                                <label for="teacherPhoneEdit">Teléfono</label>
                            </div>
                            <label id="teacherPhoneEdit-error" class="error text-bg-danger" for="teacherPhoneEdit"
                                style="font-size: 12px; border-radius: 10px; padding: 0px 5px;"></label>
                        </div>
                        <div class="col-md">
                            <div class="form-floating">
                                <input type="text" class="form-control" id="teacherEmailEdit" name="teacherEmailEdit"
                                    value="">
                                <label for="teacherEmailEdit">Correo electrónico</label>
                            </div>
