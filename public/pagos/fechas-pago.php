    ...
    <nav class="navbar bg-body-tertiary">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">
                <img src="../assets/img/escudo.png" alt="Logo" width="50" height="50"
        ...
        <div class="d-flex flex-column flex-shrink-0 p-3 bg-light" style="width: 280px; min-height: calc(100vh);">
            <ul class="nav nav-pills flex-column mb-auto">
                <li class="nav-item py-1">
                    <a href="../dashboard.php" class="btn btn-light d-flex align-items-center justify-content-start"><i
                            class="bi bi-house-fill px-3"></i>Inicio</a>
                </li>
                <li class="py-1">
                    <button class="btn btn-primary w-100 d-flex align-items-center justify-content-start" type="button"
                    ...
                    <div class="collapse" id="collapsePayments">
                        <div class="card card-body">
                            <div class="list-group">
                                ...
                                <a href="fechas-pago.php" class="list-group-item list-group-item-action">Fechas de
                                    pago</a>
                ...
                <li class="py-1">
                    <button class="btn btn-light w-100 d-flex align-items-center justify-content-start" type="button"
                        data-bs-toggle="collapse" data-bs-target="#collapseStudents" aria-expanded="false"
                    ...
                    <div class="collapse" id="collapseStudents">
                        <div class="card card-body">
                            <div class="list-group">
                                <a href="../alumnos/altas.php"
                                    class="list-group-item list-group-item-action">Agregar</a>
                ...
                <li class="py-1">
                    <button class="btn btn-light w-100 d-flex align-items-center justify-content-start" type="button"
                        data-bs-toggle="collapse" data-bs-target="#collapseTeachers" aria-expanded="false"
                ...
                <li class="py-1">
                    <button class="btn btn-light w-100 d-flex align-items-center justify-content-start" type="button"
                        data-bs-toggle="collapse" data-bs-target="#collapseGroups" aria-expanded="false"
                ...
                <li class="py-1">
                    <button class="btn btn-light w-100 d-flex align-items-center justify-content-start" type="button"
                        data-bs-toggle="collapse" data-bs-target="#collapseCarreers" aria-expanded="false"
                        aria-controls="collapseCarreers">
                        <i class="bi bi-mortarboard-fill px-3"></i>Carreras
                    </button>
                    <div class="collapse" id="collapseCarreers">
                        <div class="card card-body">
                            <div class="list-group">
                                <a href="../carreras/altas.php"
                                    class="list-group-item list-group-item-action">Agregar</a>
                ...
                <li class="py-1">
                    <button class="btn btn-light w-100 d-flex align-items-center justify-content-start" type="button"
                        data-bs-toggle="collapse" data-bs-target="#collapseSubjects" aria-expanded="false"
                ...
                <li class="py-1">
                    <button class="btn btn-light w-100 d-flex align-items-center justify-content-start" type="button"
                        data-bs-toggle="collapse" data-bs-target="#collapseUsers" aria-expanded="false"
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="row g-2 py-3">
                            <div class="col-md">
                                <h5>Dia limite de pago actual: <span class="badge text-bg-primary">
                                        <?php echo $_ENV["PAYMENT_LIMIT_DAYS"]; ?> de cada mes</span></h5>
                            </div>
                        </div>

                        <div class="row g-2 py-3">
                            <div class="col-md">
                                <h6>¿Deseas cambiar el día límite? <span class="badge text-bg-secondary"> Contacta con
                                        el administrador </span></h6>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <form id="monthAmountForm">
                    <div class="row g-2">
                        <div class="col-md">
                            ...
                            <label id="studentAmount-error" class="error text-bg-danger" for="studentAmount"
