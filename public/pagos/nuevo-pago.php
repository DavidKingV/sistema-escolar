        ...
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <a href="../pagos/pagos.php" class="btn btn-secondary">
                    <i class="fas fa-arrow-left"></i> Volver al listado de pagos
                </a>
            </div>
                        ...
                        <div class="card-body">
                            <form id="studentPaymentDate">
                                ...
                                <div id="paymentDaysContent" class="d-none">
                                    <div class="col-md">
                                        <div class="mb-3">
                                            <label id="paymentDay-error" class="error text-bg-danger" for="paymentDay"
                                                style="font-size: 12px; border-radius: 10px; padding: 0px 5px;"></label>
                                            <div class="input-group py-3">
                                                <span class="input-group-text">Cada mes los días</span>
                                                <input type="number" class="form-control" id="paymentDay"
                                                    name="paymentDay" placeholder="Registra un día de pago">
                                            </div>
                                            <div class="input-group py-3">
                                                <span class="input-group-text">Concepto</span>
                                                <select class="form-select" id="paymentConceptDay"
                                                    name="paymentConceptDay" readonly>
                                            ...
                                            <div class="input-group py-3">
                                                ...
                                                <input type="number" class="form-control" id="paymentAmountDay"
                                                    name="paymentAmountDay" placeholder="Registra el monto del pago">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row g-2 py-3">
                                        <div class="col-md">
                                            <button type="button" class="btn btn-success"
                                                id="savePaymentDays">Definir</button>
                                            <button type="button" class="btn btn-primary"
                                                id="updatePaymentDays">Actualizar</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
                ...
                <div class="card-body">
                    <form id="paymentsForm">
                        <div class="row g-2 py-3">
                            <div class="col-md">
                                <div class="mb-3">
                                    <label for="studentName">Nombre del alumno <span
                            ...
                            <div class="col-md">
                                <label for="todayDate">Fecha actual <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md">
                                <label for="paymentConcept">Concepto <span class="text-danger">*</span></label>
                                <label id="paymentConcept-error" class="error text-bg-danger" for="paymentConcept"
                                    style="font-size: 12px; border-radius: 10px; padding: 0px 5px;"></label>
                                <select class="form-select" id="paymentConcept" name="paymentConcept"
                            ...
                            <div class="col-md" id="subjectConceptDiv" hidden>
                                <label for="subjectConcept">Materia <span class="text-danger">*</span></label>
                                <label id="subjectConcept-error" class="error text-bg-danger" for="subjectConcept"
                                    style="font-size: 12px; border-radius: 10px; padding: 0px 5px;"></label>
                                <select class="form-select" id="subjectConcept" name="subjectConcept"
                                    aria-label="Floating label select example">
                            ...
                            <div class="col-md" id="childSubjectDiv" style="display: none;">
                                ...
                                <label id="childSubjectName-error" class="error text-bg-danger" for="childSubjectName"
                                    style="font-size: 12px; border-radius: 10px; padding: 0px 5px;"></label>
                                <select class="form-select" id="childSubjectName" name="childSubjectName"
                                    aria-label="Floating label select example">
                                    <option selected value="0">Asignatura (solo para Examen Extraordinario)</option>
                                </select>
                            </div>
                            <div class="col-md" id="careerDiv" hidden>
                                <label for="careerName">Carrera <span class="text-danger">*</span></label>
                                <label id="careerName-error" class="error text-bg-danger" for="careerName"
                                    style="font-size: 12px; border-radius: 10px; padding: 0px 5px;"></label>
                                <input type="text" class="form-control" id="careerName" name="careerName">
                            </div>
                            <div class="col-md">
                                <label for="paymentMonth">Mes <span class="text-danger">*</span></label>
                                <select class="form-select" id="paymentMonth" name="paymentMonth"
                                    aria-label="Floating label select example" disabled>
                                    <option selected value="0">Selecciona una opción</option>
                        ...
                        <div class="row g-2">
                            <div class="col-md">
                                <div class="mb-3">
                                    <label for="paymentPrice">Monto <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md">
                                <label for="paymentExtraCkeck">Recargo <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md">
                                <div class="mb-3">
                                    <label for="paymentTotal">Total <span class="text-danger">*</span></label>
                                    <div class="input-group">
                                        <span class="input-group-text">$</span>
                        ...
                        <div class="row g-2 py-2">
                            <div class="col-md">
                                <label for="paymentMethod">Método de pago <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md">
                                <label for="paymentInvoice">Tipo de comprobante <span
                                        class="text-danger">*</span></label>
                                <select class="form-select" id="paymentInvoice" name="paymentInvoice"
                                    aria-label="Floating label select example">
                        ...
                        <div class="row g-2 py-2">
                            <div class="col-md">
                                ...
                                <textarea type="text" class="form-control" id="paymentComments" name="paymentComments"
