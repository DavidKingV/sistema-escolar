...
$(function() {
    ...
    if (currentPath === specificPath) {
        ...
        $.getJSON('../php/carreers/areas.json', function(carreras) {
    ...
    try {
        ...
        const getDefaultCareer = async () => {
            const response = await $.ajax({
                url: 'php/carreers/routes.php', // Cambia esta URL a tu ruta real
                type: 'GET',
        ...
        const loadCareers = async () => {
            const response = await $.getJSON('php/carreers/areas.json');
            return response;
        };
